(define (problem problem-v0)
    ...
    (:init
        ...
        (robot_at robot1 delivery_location)

        (robot_at robot2 part_location1)
        (robot_at robot3 in_front_of_air_lock2)
        ...
        (= (allowed_to_enter robot2) 9)
        (= (allowed_to_enter robot1) 3)
        (= (allowed_to_enter robot3) 3)

        (= (amr_location robot0) 6)
        (= (amr_location robot1) 8)
        (= (amr_location robot2) 9)
        (= (amr_location robot3) 2)
        ...
        ; (location_is_free in_front_of_air_lock2)
        ...
        ; (= (factory_location robot1_safe_location) 1)

        ;; in_front_of_air_lock1 is on the clean side of the air lock
    ...
    (:goal
        (and 
            ...
            (piece_at wafer3 delivery_location)
            (piece_at wafer4 delivery_location)
            (piece_at wafer5 delivery_location)
            (piece_at wafer6 delivery_location)
            (piece_at wafer7 delivery_location)
            (piece_at wafer8 delivery_location)
            (piece_at wafer9 delivery_location)
            (piece_at wafer10 delivery_location)
        )
    )

    (:metric
        minimize (* (total-time) 3)   
    )
